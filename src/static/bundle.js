...
},{"react":159,"swipe-js-iso":160}],31:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
try {
  for (var _iterator = pictures.entries()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
},{"./gallery":162,"react":159,"react-dom":29}],162:[function(require,module,exports){
'use strict';
...
var Gallery = function (_Component) {
  ...
  function Gallery(props) {
    ...
    _this.swipedHandler = _this.swipedHandler.bind(_this);
    return _this;
  }
  ...
  _createClass(Gallery, [{
    ...
    key: 'swiped',
    value: function swiped(diff) {
      var activeIndex = this.state.activeIndex;
      var pictures = this.props.pictures;


      var index = mod(this.state.activeIndex + diff, pictures.length);
    ...
    key: 'swipedHandler',
    value: function swipedHandler(move) {
      var diff = move ? +1 : -1;
      this.swiped(diff);
    }
  }, {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'div',
              { className: 'gallery__image-src-wrap' },
...
},{"./thumbs":163,"./togglers":164,"react":159,"react-swipe":30}],163:[function(require,module,exports){
'use strict';
...
},{"./togglers":164,"react":159}],164:[function(require,module,exports){
"use strict";
